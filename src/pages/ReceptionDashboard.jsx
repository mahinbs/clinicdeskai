...
import { UserPlus, Clock, CheckCircle, Activity, ArrowRight, User } from 'lucide-react';
...
const ReceptionDashboard = () => {
    ...
    const waiting = todayTokens.filter(t => t.status === 'waiting' || t.status === 'with_doctor').length;
